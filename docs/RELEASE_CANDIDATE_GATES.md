...
- `telemetry.json` includes PPU fine-X scroll-seam frame-pixel samples so automated debuggers can localize horizontal background seam regressions to `ppu.scroll_seam`.
