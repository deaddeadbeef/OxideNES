...
- Diagnostic bundles include a bounded instruction trace tail so failed headless runs preserve the final opcode-boundary CPU/RAM context for automated triage.
