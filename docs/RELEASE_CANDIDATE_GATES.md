...
- The diagnostic e2e runner passes and writes the root acceptance report, AI observability index, and AI query smoke after observability, route matrix, top-route replay, and route evidence verification:
