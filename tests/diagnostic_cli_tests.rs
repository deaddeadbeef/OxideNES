...
fn diagnostic_cli_writes_ai_ready_scenario_suite() {
    ...
    assert_eq!(manifest["scenario_suite_schema_version"], Value::from(10));
    assert_eq!(manifest["telemetry_schema_version"], Value::from(59));
    ...
    assert_eq!(manifest["scenario_count"], Value::from(33));
    assert_eq!(
    ...
    assert_eq!(manifest["analysis"]["scenario_count"], Value::from(33));
    assert_eq!(
    ...
    assert_eq!(attention_queue.len(), 25);
    ...
    assert_eq!(observer["scenario_suite_schema_version"], Value::from(10));
    assert_eq!(observer["telemetry_schema_version"], Value::from(59));
    ...
    assert!(suite_report.contains("| Baseline divergences | 25 |"));
    ...
    assert!(
        suite_report.contains("| input_mask_matrix_pass | true | true | true | healthy | 37 | - |")
    );
    assert!(suite_report
        .contains("| input_mask_all_released_pass | true | true | true | healthy | 37 | - |"));
    assert!(suite_report
        .contains("| input_mask_all_pressed_pass | true | true | true | healthy | 37 | - |"));
    assert!(suite_report
        .contains("| input_mask_joypad1_pressed_pass | true | true | true | healthy | 37 | - |"));
    assert!(suite_report
        .contains("| input_mask_joypad2_pressed_pass | true | true | true | healthy | 37 | - |"));
    assert!(suite_report
        .contains("| input_mask_sparse_bits_pass | true | true | true | healthy | 37 | - |"));
    assert!(suite_report
        .contains("| input_mask_nibble_split_pass | true | true | true | healthy | 37 | - |"));
    ...
    assert_eq!(pass["actual_focus_test_id"], Value::from(37));
    ...
    assert_eq!(pass["contract"]["expected_focus_test_id"], Value::from(37));
    assert_eq!(pass["contract"]["actual_focus_test_id"], Value::from(37));
    ...
    assert_eq!(input_matrix["actual_focus_test_id"], Value::from(37));
...
fn diagnostic_cli_writes_standalone_triage_json() {
    ...
    assert_eq!(triage["telemetry_schema_version"], Value::from(59));
    ...
    assert_eq!(
        ...
        Value::String("cpu_read_modify_write_matrix".to_string())
    );
    assert_eq!(
    ...
    assert_eq!(triage["coverage"]["passed_tests"], Value::from(29));
