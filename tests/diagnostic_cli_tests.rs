...
fn diagnostic_cli_writes_ai_ready_scenario_suite() {
    ...
    assert_eq!(manifest["scenario_count"], Value::from(42));
    assert_eq!(
    ...
    assert_eq!(manifest["analysis"]["scenario_count"], Value::from(42));
    assert_eq!(
    ...
    assert_eq!(attention_queue.len(), 34);
    ...
    assert_eq!(observer["baseline_divergence_count"], Value::from(34));
    let observer_actions = observer["next_actions"]
        .as_array()
        .expect("observer next_actions should be an array");
    assert_eq!(observer_actions.len(), 34);
    ...
    assert!(suite_report.contains("| Baseline divergences | 34 |"));
    ...
    assert!(
        suite_report.contains("| input_mask_matrix_pass | true | true | true | healthy | 46 | - |")
    );
    assert!(suite_report
        .contains("| input_mask_all_released_pass | true | true | true | healthy | 46 | - |"));
    assert!(suite_report
        .contains("| input_mask_all_pressed_pass | true | true | true | healthy | 46 | - |"));
    assert!(suite_report
        .contains("| input_mask_joypad1_pressed_pass | true | true | true | healthy | 46 | - |"));
    assert!(suite_report
        .contains("| input_mask_joypad2_pressed_pass | true | true | true | healthy | 46 | - |"));
    assert!(suite_report
        .contains("| input_mask_sparse_bits_pass | true | true | true | healthy | 46 | - |"));
    assert!(suite_report
        .contains("| input_mask_nibble_split_pass | true | true | true | healthy | 46 | - |"));
    ...
    assert_eq!(pass["actual_focus_test_id"], Value::from(46));
    ...
    assert_eq!(pass["contract"]["expected_focus_test_id"], Value::from(46));
    assert_eq!(pass["contract"]["actual_focus_test_id"], Value::from(46));
    ...
    assert_eq!(input_matrix["actual_focus_test_id"], Value::from(46));
...
fn diagnostic_cli_writes_standalone_triage_json() {
    ...
    assert_eq!(triage["coverage"]["passed_tests"], Value::from(38));
