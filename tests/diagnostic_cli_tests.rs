...
fn diagnostic_cli_writes_exhaustive_input_sweep_artifacts() {
    ...
    assert_eq!(sweep["telemetry_schema_version"], Value::from(70));
...
fn diagnostic_cli_writes_ai_ready_scenario_suite() {
    ...
    assert_eq!(manifest["scenario_suite_schema_version"], Value::from(21));
    assert_eq!(manifest["telemetry_schema_version"], Value::from(70));
    ...
    assert_eq!(manifest["scenario_count"], Value::from(43));
    assert_eq!(
    ...
    assert_eq!(manifest["analysis"]["scenario_count"], Value::from(43));
    assert_eq!(
    ...
    assert_eq!(attention_queue.len(), 35);
    ...
    assert_eq!(observer["scenario_suite_schema_version"], Value::from(21));
    assert_eq!(observer["telemetry_schema_version"], Value::from(70));
    ...
    assert!(suite_report.contains("| Baseline divergences | 35 |"));
...
fn diagnostic_cli_writes_standalone_triage_json() {
    ...
    assert_eq!(triage["telemetry_schema_version"], Value::from(70));
    ...
    assert_eq!(triage["coverage"]["passed_tests"], Value::from(39));
