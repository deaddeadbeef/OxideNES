...
fn diagnostic_cli_writes_ai_ready_scenario_suite() {
    ...
    assert_eq!(manifest["scenario_count"], Value::from(27));
    assert_eq!(
    ...
    assert_eq!(manifest["analysis"]["scenario_count"], Value::from(27));
    assert_eq!(
    ...
    assert_eq!(observer["scenario_count"], Value::from(27));
