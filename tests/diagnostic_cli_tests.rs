...
fn diagnostic_cli_writes_exhaustive_input_sweep_artifacts() {
    ...
    assert_eq!(sweep["telemetry_schema_version"], Value::from(71));
...
fn diagnostic_cli_writes_ai_ready_scenario_suite() {
    ...
    assert_eq!(manifest["scenario_suite_schema_version"], Value::from(22));
    assert_eq!(manifest["telemetry_schema_version"], Value::from(71));
    ...
    assert_eq!(manifest["scenario_count"], Value::from(44));
    assert_eq!(
    ...
    assert_eq!(manifest["analysis"]["scenario_count"], Value::from(44));
    assert_eq!(
    ...
    assert_eq!(attention_queue.len(), 36);
    ...
    assert_eq!(observer["scenario_suite_schema_version"], Value::from(22));
    assert_eq!(observer["telemetry_schema_version"], Value::from(71));
    ...
    assert!(suite_report.contains("| Baseline divergences | 36 |"));
...
fn diagnostic_cli_writes_standalone_triage_json() {
    ...
    assert_eq!(triage["telemetry_schema_version"], Value::from(71));
    ...
    assert_eq!(triage["coverage"]["passed_tests"], Value::from(40));
