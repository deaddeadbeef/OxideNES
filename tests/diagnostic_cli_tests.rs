...
fn diagnostic_cli_writes_ai_ready_scenario_suite() {
    ...
    assert_eq!(manifest["telemetry_schema_version"], Value::from(54));
    ...
    assert_eq!(observer["telemetry_schema_version"], Value::from(54));
    ...
    assert!(suite_report
        .contains("| input_mask_all_released_pass | true | true | true | healthy | 28 | - |"));
    assert!(suite_report
        .contains("| input_mask_all_pressed_pass | true | true | true | healthy | 28 | - |"));
    assert!(suite_report
...
fn diagnostic_cli_writes_standalone_triage_json() {
    ...
    assert_eq!(triage["telemetry_schema_version"], Value::from(54));
    ...
    assert_eq!(
        ...
        Value::String("ppu_scroll_seam_matrix".to_string())
    );
    assert_eq!(
