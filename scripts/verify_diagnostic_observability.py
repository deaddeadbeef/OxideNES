...
EXPECTED_SCENARIO_COUNT = 39
EXPECTED_ACTIONABLE_SCENARIO_COUNT = 31
EXPECTED_PASS_SCENARIO_COUNT = 8
EXPECTED_CARTRIDGE_TEST_COUNT = 35
EXPECTED_CARTRIDGE_TEST_IDS = set(range(1, 29)) | {37, 38, 39, 40, 41, 42, 43}
EXPECTED_COVERAGE_GAP_COUNT = 6
EXPECTED_PROBE_COUNT = 77
