...
def build_smoke_summary(
    ...
    add_check("scenario_cards", summary.get("scenario_count") == 20, summary.get("scenario_count"))
    add_check(
        "actionable_scenarios",
        summary.get("actionable_scenario_count") == 18,
        summary.get("actionable_scenario_count"),
    )
    add_check("focus_domains", summary.get("focus_domain_count") == 18, summary.get("focus_domain_count"))
    add_check(
        "top_route",
