...
FOCUS_DOMAIN_CODE_MAP = {
    ...
    "cpu.stack.status_matrix": {
        "subsystem": "cpu",
        "description": "6502 stack pointer, push/pop, status push/pull, and JSR/RTS stack behavior observed through diagnostic sentinels.",
        "source_files": ["src/cpu.rs"],
        "test_files": ["tests/cpu_tests.rs", "tests/diagnostic_cartridge_tests.rs"],
        "search_terms": [
            "PHA",
    ...
    "cpu.compare.flags": {
        "subsystem": "cpu",
        "description": "6502 CMP, CPX, and CPY register compare carry, zero, and negative flag behavior observed through diagnostic sentinels.",
        "source_files": ["src/cpu.rs", "src/diagnostic.rs"],
        "test_files": ["tests/cpu_tests.rs", "tests/diagnostic_cartridge_tests.rs"],
        "search_terms": [
            "CMP",
            ...
            "compare",
            "carry",
            "cpu_compare_register_matrix",
        ],
    },
    "cpu.load_store.transfer_matrix": {
        "subsystem": "cpu",
        "description": "6502 LDA/LDX/LDY load flags, STA/STX/STY store side effects, and TAX/TAY/TXA/TYA transfer behavior observed through diagnostic sentinels.",
        "source_files": ["src/cpu.rs", "src/diagnostic.rs"],
        "test_files": ["tests/cpu_tests.rs", "tests/diagnostic_cartridge_tests.rs"],
        "search_terms": [
            "LDA",
            ...
            "TXA",
            "TYA",
            "cpu_load_store_transfer_matrix",
        ],
    },
    ...
    "cpu.rmw.asl": {
        ...
        "search_terms": [
            ...
            "ROR",
            "AddressingMode::ZeroPage",
            "cpu_read_modify_write_matrix",
        ],
    },
    "cpu.rmw.absolute_asl": {
        "subsystem": "cpu",
        "description": "6502 read-modify-write absolute and absolute,X opcode sequencing, page-crossing indexed effective addresses, and memory write-back behavior.",
        "source_files": ["src/cpu.rs"],
        "test_files": ["tests/cpu_tests.rs", "tests/diagnostic_cartridge_tests.rs"],
        "search_terms": [
            "ASL",
