...
fn diagnostic_scenario_specs() -> Vec<DiagnosticScenarioSpec> {
    ...
    specs.extend([
        ...
        DiagnosticScenarioSpec {
            ...
            expected_passed: false,
            expected_health: DiagnosticHealth::CartridgeAssertionFailed,
            expected_focus_test_id: Some(12),
        ...
        DiagnosticScenarioSpec {
            id: "cpu_rmw_matrix_fault",
            title: "Intentional CPU read-modify-write matrix assertion failure",
            purpose: "Failure-localization fixture for zero-page RMW opcode write-back regressions.",
            config: DiagnosticConfig {
        ...
        DiagnosticScenarioSpec {
            id: "cpu_branch_matrix_fault",
            title: "Intentional CPU branch condition-matrix assertion failure",
            purpose: "Failure-localization fixture for conditional branch opcode, flag-condition, and page-crossing regressions.",
            config: DiagnosticConfig {
            ...
            expected_passed: false,
            expected_health: DiagnosticHealth::CartridgeAssertionFailed,
            expected_focus_test_id: Some(39),
            expected_focus_domain: Some("cpu.branch.condition_matrix"),
        },
        DiagnosticScenarioSpec {
            id: "cpu_stack_matrix_fault",
            title: "Intentional CPU stack status-matrix assertion failure",
            purpose: "Failure-localization fixture for stack pointer, push/pop, status push/pull, and JSR/RTS regressions.",
            config: DiagnosticConfig {
        ...
        DiagnosticScenarioSpec {
            id: "cpu_compare_matrix_fault",
            title: "Intentional CPU compare register matrix assertion failure",
            purpose: "Failure-localization fixture for CMP/CPX/CPY carry, zero, and negative flag regressions.",
            config: DiagnosticConfig {
            ...
            expected_passed: false,
            expected_health: DiagnosticHealth::CartridgeAssertionFailed,
            expected_focus_test_id: Some(43),
            expected_focus_domain: Some("cpu.compare.flags"),
        },
        DiagnosticScenarioSpec {
            id: "cpu_load_store_matrix_fault",
            title: "Intentional CPU load/store/transfer matrix assertion failure",
            purpose: "Failure-localization fixture for LDA/LDX/LDY load flags, STA/STX/STY store side effects, and TAX/TAY/TXA/TYA transfer regressions.",
            config: DiagnosticConfig {
        ...
        DiagnosticScenarioSpec {
            id: "mapper2_bank_switch_fault",
            title: "Intentional Mapper 2 PRG bank-switch assertion failure",
            purpose: "Failure-localization fixture for UXROM PRG bank-switching regressions.",
            config: DiagnosticConfig {
        ...
        DiagnosticScenarioSpec {
            id: "ppu_nametable_mirroring_fault",
            title: "Intentional PPU nametable mirroring assertion failure",
            purpose: "Failure-localization fixture for horizontal nametable mirroring regressions.",
            config: DiagnosticConfig {
        ...
        DiagnosticScenarioSpec {
            id: "ppu_scroll_seam_fault",
            title: "Intentional PPU scroll-seam host-observation failure",
            purpose:
                "Failure-localization fixture for fine-X horizontal scroll seam regressions.",
            config: DiagnosticConfig {
